...
{
    if(document.getElementById("pickupstoreaddress").value !== "" && document.getElementById("town").value !== "" && document.getElementById("province").value !=="" && document.getElementById("city").value !=="" )
    {
        ...
        else if (document.getElementById("returnaddress").value !== "" && document.getElementById("returntown").value !== "" && document.getElementById("returnprovince").value !=="" && document.getElementById("returncity").value !=="" )
        {
            document.getElementById("form3").style.display='none';
            document.getElementById("form4").style.display='block';
            startTimer();
